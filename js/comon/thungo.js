      ...
      $.ajax({
          ...
          success: function (data) {
              if (data && Object.keys(data).length !== 0) {
                              ...
                              <div class="swiper-slide">
                                  <div class="py-4 ml-auto mr-auto text-center">
                                      ...
                                      <div class="d-lg-none w-100">
                                          <img src="${slide.image}" class="img-container" alt="${slide.title} header" loading="lazy"/>
                                      </div>
                                  </div>
                              </div>
                          `;
                  ...
                  //San Pham
                  if (data.product && data.product.slides && data.product.slides.length > 0) {
                  ...
                  //logo
                  if (data.logo && data.logo.slides && data.logo.slides.length > 0) {
                  ...
                  //Member
                  if (data.Member && data.Member.memberSlides && data.Member.memberSlides.length > 0) {
